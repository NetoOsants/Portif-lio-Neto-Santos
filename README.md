...
- **Página inicial:** apresentação, resumo profissional, projetos em destaque e seção “Sobre mim”.
- **Projetos:** cards com acesso às páginas individuais de cada projeto.
- **Página individual:** contexto, tecnologias, desafio e funcionalidades de cada solução.
- **Stacks / habilidades:** tecnologias que utilizo e áreas que estou desenvolvendo.
...
- dashboard gerencial com visão consolidada;
- controle de RDOs, equipes e contratos ativos;
- acompanhamento de logística e combustível;
